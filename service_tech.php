                            ...
                            <div class="tab-pane" id="about">
                                <div class="row">
                                    <div style="margin:auto;">
                                        <div style="margin:auto;">
                                            <a href="manage_report_tech.php" style="text-decoration: none; color: black; ">
                                                <img src="assets/img/Manage%20Reports%20.png" alt="" width="150" />
                                                <p style="margin-left:20px">Manage report</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
