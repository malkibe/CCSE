                            ...
                            <div class="tab-content">
                                <div class="tab-pane" id="about">
                                    <div class="form-horizontal">
                                        ...
                                        <?php
                                        if(isset($_POST['id'])){
                                            $stmt = $mysqli->prepare("SELECT `status`, `tech_note` FROM `report` WHERE `id` = ?");
                                            ...
                                            if($result->num_rows > 0){
                                              while($row = $result->fetch_assoc()) {
                                               ...
                                               echo  '<div class="form-group">
                                                    <div class="col-sm-2 control-label">
                                                        <label for="Comment">Technician note</label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <textarea name="comment" class="form-control" readonly>'.$tech_note.'</textarea>
                                                    </div>
                                                </div>';
                                                }
                                                if($status != null){
                                                ...
                                                <div class="col-sm-8">
                                                <input class="btn btn-info" style="font-size: 15px;font-weight: bold" value="'.$status.'" readonly>
                                                </div>
                                                </div> ';
                                                }
                                            }
